...
CREATE TABLE "new_CreateInquiryFormCommand" (
    ...
    CONSTRAINT "CreateInquiryFormCommand_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_StudentRecognitionModel" (
    ...
    CONSTRAINT "StudentRecognitionModel_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_Alert" (
    ...
    CONSTRAINT "Alert_studentID_fkey" FOREIGN KEY ("studentID") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_ClassEnrollment" (
    ...
    CONSTRAINT "ClassEnrollment_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE "new_EmergencyContact" (
    ...
    CONSTRAINT "EmergencyContact_studentID_fkey" FOREIGN KEY ("studentID") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_ParentStudent" (
    ...
    CONSTRAINT "ParentStudent_studentID_fkey" FOREIGN KEY ("studentID") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE "new__LockerModelToStudent" (
    ...
    CONSTRAINT "_LockerModelToStudent_B_fkey" FOREIGN KEY ("B") REFERENCES "StudentModel" ("personStudentId") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_StudentSchool" (
    ...
    "nextSchoolCode" TEXT,
    "nextGradeLevel" TEXT,
    CONSTRAINT "StudentSchool_personId_fkey" FOREIGN KEY ("personId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_PickupContact" (
    ...
    CONSTRAINT "PickupContact_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_EnrollmentHistory" (
    ...
    CONSTRAINT "EnrollmentHistory_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_AdvisingNote" (
    ...
    CONSTRAINT "AdvisingNote_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_AssignmentGradesModel" (
    ...
    CONSTRAINT "AssignmentGradesModel_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE "new_InquiryFormModel" (
    ...
    CONSTRAINT "InquiryFormModel_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_Conference" (
    ...
    CONSTRAINT "Conference_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "new_BehaviorEvents" (
    ...
    CONSTRAINT "BehaviorEvents_studentID_fkey" FOREIGN KEY ("studentID") REFERENCES "StudentModel" ("personStudentId") ON DELETE NO ACTION ON UPDATE NO ACTION
);
