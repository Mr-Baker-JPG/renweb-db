/*
  ...
  - You are about to drop the column `locker` on the `StudentModel` table. All the data in the column will be lost.
...
CREATE TABLE "new_StudentModel" (
    ...
    "schoolCode" TEXT,
    CONSTRAINT "StudentModel_lockerId_fkey" FOREIGN KEY ("lockerId") REFERENCES "LockerModel" ("lockerId") ON DELETE NO ACTION ON UPDATE NO ACTION,
